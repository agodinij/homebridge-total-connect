...
TotalConnectClient.prototype.Login = function(callback, method, target)
{
     var that = this;
...
TotalConnectClient.prototype.GetSessionDetails = function(callback, method, that, target) {
...
TotalConnectClient.prototype.GetCurrentState = function(callback) {
    ...
    this.Login(callback, this.GetCurrentStateAuthenticated, null);
}

TotalConnectClient.prototype.GetCurrentStateAuthenticated = function(callback, that, target) {
    //Call
...
TotalConnectClient.prototype.SetTargetState = function(callback, state) {
    var method = null;
    var target = null;
    switch (state) {
        case "away":
...
TotalConnectClient.prototype.ArmAuthenticated = function(callback, that, target) {
...
TotalConnectClient.prototype.DisarmAuthenticated = function(callback, that, target) {
