...
TotalConnectClient.prototype.SetTargetState = function(callback, state) {
    ...
    switch (state) {
        case "away":
          method = this.ArmAuthenticated("0");
          break;
        case "stay":
          method = this.ArmAuthenticated("1");
          break;
        case "away":
          method = this.ArmAuthenticated("4");
          break;
        case "disarm":
        default:
    ...
    this.Login(callback, method);
}

TotalConnectClient.prototype.ArmAuthenticated = function(callback, that, armType) {
